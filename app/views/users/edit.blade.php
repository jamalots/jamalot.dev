...
<div class="container">
        ...
        {{ Form::open(array('action' => array('UsersController@update'), 'files'=>true)) }}
            ...
            <div class="form-group">
                ...
                {{ Form::select('original', null, array('Originals' => 'Originals', 'Covers' => 'Covers', 'Both' => 'Both'), 'Originals'); }}
            </div>
            ...
            <div class="form-group">
				...
				{{ Form::select('user_type', null, array('Musician' => 'Musician', 'Band' => 'Band'), 'Musician'); }}
