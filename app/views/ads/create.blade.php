...
{{ Form::open(array('action' => array('UsersController@update', Auth::id()), 'files'=>true, 'id' => 'msform', 'method' => 'PUT')) }}
  <!-- progressbar -->
  <ul id="progressbar">
    <li class="active">Create a Jam</li>
    <li>Jam Details</li>
    <li>Location</li>
  </ul>
  <!-- fieldsets -->
  <fieldset>
    <h2 class="fs-title">Create a Jam</h2>
    <h3 class="fs-subtitle">Musician(s) Desired</h3>
    <label for="ad_type">Jam Type:</label>
    <select id="ad_type" class="selectpicker form-control" data-live-search="true" name="ad_type" required>
        <optgroup label="Jams">
          <option>Informal Jam</option>
          <option>Formal Jam/Practice/Rehearsal</option>
          <option>Payed Gig</option>
        </optgroup>
        <optgroup label="Lessons">
          <option>Offering Lessons</option>
          <option>Wanting Lessons</option>
        </optgroup>
    </select>
    ...
    <label for="ad_need">Instrument(s) Wanted (Select Up to 4):</label>
    <select id="basic" class="selectpicker form-control" multiple data-max-options="4" data-live-search="true" name="ad_need">
    ...
    <label for="genre">Genre (Select up to 3):</label>
    <select id="basic" class="selectpicker form-control" multiple data-max-options="3" data-live-search="true" name="genre">
  ...
  <fieldset>
    <h2 class="fs-title">Jam Details</h2>
    <h3 class="fs-subtitle">A bit about the Jam</h3>
    <label for="ad_title">Title:</label>
    <input type="text" name="ad_title" class = "form-control" id="ad_title">
    ...
    <input type="file" class="filestyle" name="ad_img" data-buttonName="btn-success" data-input="false">
  ...
  <fieldset>
    ...
    <select id="venue_type" class="selectpicker form-control" data-live-search="true" name="venue_type">
      <option>House</option>
      <option>Venue</option>
    ...
    <select id="level" class="selectpicker form-control" multiple data-max-options="5" data-live-search="true" name="equipment">
      <optgroup label="Front End">
        <option>P/A System</option>
      </optgroup>
      <optgroup label="Backline">
